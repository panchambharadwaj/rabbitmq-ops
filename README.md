...
Sends Email alerts when Threshold and Ack Rate limits are breached for a queue.
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/panchambharadwaj/rabbitmq-ops/blob/master/LICENSE) file for details